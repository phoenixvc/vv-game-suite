...
export default function GameMechanicsPanel() {
  return (
    <div className="space-y-6">
          ...
          <Tabs defaultValue="overview">
            ...
            <TabsContent value="overview">
              <div className="space-y-4">
                <p className="text-gray-300">
                  Crisis Unleashed is a fast-paced, faction-driven collectible card game where players assume the role
                  of powerful masterminds vying for dominance in a collapsing world. With a mix of strategic deck
                  construction, resource management, lane-based combat, and dynamic global events, each match is a
                  high-stakes duel shaped by shifting crises and evolving tactics.
                </p>

                <h3 className="text-lg font-semibold">Core Premise</h3>
                <p className="text-gray-300">
                  In a world pushed to the brink by reality-bending anomalies, rogue technologies, ancient powers, and
                  cosmic instabilities, five dominant factions rise to command the future. Players lead their forces
                  through a mix of carefully crafted Character, Action, and Hero cards — all while adapting to
                  game-changing Crisis Events drawn each round.
                </p>

                <h3 className="text-lg font-semibold">Factions</h3>
                <ul className="list-disc pl-5 space-y-1 text-gray-300">
                  <li>
                    <span className="text-cyan-400 font-bold">Cybernetic Nexus</span>: Masters of digital disruption and
                    quantum control
                  </li>
                  <li>
                    <span className="text-purple-400 font-bold">Eclipsed Order</span>: Shadow operatives who manipulate
                    the battlefield from concealment
                  </li>
                  <li>
                    <span className="text-green-400 font-bold">Primordial Ascendancy</span>: Elemental forces of nature
                    and evolution
                  </li>
                  <li>
                    <span className="text-yellow-400 font-bold">Celestial Dominion</span>: Cosmic entities wielding time
                    and reality
                  </li>
                  <li>
                    <span className="text-red-400 font-bold">Titanborn</span>: Raw kinetic warriors of overwhelming
                    physical might
                  </li>
                </ul>
              </div>
            ...
            <TabsContent value="combat">
              <div className="space-y-4">
                ...
                <p className="text-gray-300">
                  Combat in Crisis Unleashed takes place across three lanes: Front, Middle, and Back. Each lane has
                  strategic importance and different cards excel in different positions.
                </p>
                ...
                <div className="grid grid-cols-3 gap-4 mt-4">
                  <div className="bg-gray-700 p-3 rounded hover:bg-gray-600 transition-colors duration-200 hover:shadow-md">
                    ...
                    <p className="text-sm text-gray-300">
                      Ideal for tanks and melee fighters. Cards here can protect cards in other lanes and often have
                  ...
                  <div className="bg-gray-700 p-3 rounded hover:bg-gray-600 transition-colors duration-200 hover:shadow-md">
                    ...
                    <p className="text-sm text-gray-300">
                      Versatile position for balanced cards. Units here can attack any lane but are more vulnerable than
                      front lane units.
                    </p>
                  </div>
                  <div className="bg-gray-700 p-3 rounded hover:bg-gray-600 transition-colors duration-200 hover:shadow-md">
                    ...
                    <p className="text-sm text-gray-300">
                      Reserved for support units and ranged attackers. Cards here are protected but can only be attacked
                ...
                <p className="text-gray-300">
                  Cards have Attack and Defense values that determine combat outcomes. When a card attacks, it deals
                  damage equal to its Attack value. The defending card reduces this damage by its Defense value before
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  ...
                  <div className="bg-gray-700 p-3 rounded">
                    ...
                    <p className="text-sm text-gray-300">
                      ...
                      Ultimate Moves and special abilities.
                    </p>
                  </div>
                </div>
            ...
            <TabsContent value="artifacts">
              <div className="space-y-4">
                ...
                <p className="text-gray-300">
                  Artifacts are a special type of card that provide persistent passive effects and occasionally grant
                  activated abilities. Only one Artifact can be in play per player at a time.
                </p>
                ...
                <p className="text-gray-300 mt-4">
                  Artifacts are played from the Action Deck and remain in play until destroyed or replaced. Strategic
                  timing of Artifact deployment can be crucial to victory.
                </p>
              </div>
            </TabsContent>
            ...
            <TabsContent value="crisis">
              <div className="space-y-4">
                ...
                <p className="text-gray-300">
                  Every round begins with a global effect that changes how the battlefield works. These Crisis Events
                  force players to adapt their strategies on the fly.
                </p>
      ...
      <Card className="bg-gray-800 border-gray-700 shadow-lg hover:shadow-xl transition-shadow duration-300">
        <CardContent className="p-6">
          ...
          <p className="text-gray-300">
            Crisis Unleashed is developed and published by VeritasVault, a pioneering company at the intersection of
            blockchain technology and gaming. All cards can be minted as NFTs, allowing players to truly own their
            digital assets.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div className="bg-gray-700 p-3 rounded hover:bg-gray-600 transition-colors duration-200 hover:shadow-md">
              ...
              <p className="text-sm text-gray-300">
                Cards can be minted, traded, and sold on the blockchain, with all transactions secured by VeritasVault's
