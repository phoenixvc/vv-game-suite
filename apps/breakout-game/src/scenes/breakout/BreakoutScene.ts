 ...
 * This method can be called from PaddleFactory to create the correct physics shape
 */
public createPaddlePhysicsShape(paddle: Phaser.Physics.Matter.Sprite, isConcave: boolean): void {
  try {
    ...
    this.matter.world.remove(paddle.body);
    ...
    if (isConcave) {
      ...
      if (isVertical) {
        ...
        paddleBody = this.matter.body.create({
          parts: parts,
          isStatic: true,
